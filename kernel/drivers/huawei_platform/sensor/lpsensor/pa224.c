/* < DTS2015070304163 wushengyu 20150703 begin */
/* < DTS2015062400454 wushengyu 20150624 begin */
/* < DTS2015051901259 wushengyu 20150528 begin */
/* DTS2015042802618 wushengyu 20150428 begin> */
/* DTS2015031709091 wushengyu 20150317 begin> */
/* DTS2015031604601 wushengyu 20150316 begin> */
/* < DTS2015031304150 wushengyu 20150313 begin */
/* < DTS2015030203957  wushengyu 20150302 begin */
/* < DTS2015021100512  wushengyu 20150211 begin */
/* < DTS2015061204067 wangcunyou 20150612 begin */
...
static int txc_pa2240_i2c_read(struct i2c_client*client, u8 reg,bool flag)
{
	...
	while(loop) {
		...
		if(err < 0){
			loop--;
			/* DTS2015040204266 wuying/wx221431 20150402 begin> */
			msleep(TXC_PA2240_I2C_RETRY_TIMEOUT);
			/* DTS2015040204266 wuying/wx221431 20150402 end > */
		}
		else
			break;
	}
...
static int txc_pa2240_run_fast_calibration(struct i2c_client *client)
{
	...
	/* < DTS2015030701294   dingjingfeng 20150307 begin */
	...
	/* DTS2015030701294   dingjingfeng 20150307 end > */
	else
	{
		/*calibration failure*/
...
//		txc_pa2240_set_flct(client,(TXC_PA2240_FILTER | (PA2240_PS_FLCT<<4)));
		...
		/* < DTS2015061006245 zhoujian/wx221429 20150610 begin */
		data->ps_detection = TXC_PA2240_FAR_FLAG;
		/* DTS2015061006245 zhoujian/wx221429 20150610 end > */
...
/* DTS2015061204067 wangcunyou 20150612 end > */
/* DTS2015021100512  wushengyu 20150211 end > */
/* DTS2015030203957  wushengyu 20150302 end > */
/* DTS2015031304150 wushengyu 20150313 end >*/
/* DTS2015031604601 wushengyu 20150316 end > */
/* DTS2015031709091 wushengyu 20150317 end > */
/* DTS2015042802618 wushengyu 20150428 end > */
/* DTS2015051901259 wushengyu 20150528 end > */
/* DTS2015062400454 wushengyu 20150624 end > */
/* DTS2015070304163 wushengyu 20150624 end > */