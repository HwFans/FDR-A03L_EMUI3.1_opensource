...
/* <DTS2016030206866 liuanqi 20160303 begin */
#define B_R_RATIO_PARAMETER	300
/* DTS2016030206866 liuanqi 20160303 end > */
...
/* < DTS2015092109049 wuying/wx221431 20150922 begin */
static int apds_als_polling_count=0;
/* DTS2015092109049 wuying/wx221431 20150922 end > */
...
static int LuxCalculation(struct i2c_client *client)
{
	...
	if (ir_r_ratio/100 > avago_cofficient[0]){
		...
		lux = data->rgb_data.green*LUX_R/((apds9251_als_meas_rate_tb[data->als_res_index])*apds9251_als_gain_tb[4]);
	/* <DTS2016030206866 liuanqi 20160303 begin */
		if (b_r_ratio > B_R_RATIO_PARAMETER){
...
enable_delay:
	/* < DTS2016011209026 chendong 20160113 begin */
	msleep(10);
	/* DTS2016011209026 chendong 20160113 end > */
