/* < DTS2014042508608 caowei 20140425 begin */
...
/* < DTS2014051204051 yanghaizhou 20140513 begin */
#define IS_TP_SUSPENDED    1
#define NOT_TP_SUSPENDED   0
/* < DTS2014051204051 yanghaizhou 20140513 end */
...
/* < DTS2014051506063 yanghaizhou 20140515 begin */
...
#endif
/* DTS2014051506063 yanghaizhou 20140515 end >*/

/* <  DTS2014061205851  yanghaizhou 20140616 begin*/
#define WRITE_CHECK
...
/* < DTS2014061500170 yanghaizhou 20140615 begin */
extern struct dsm_dev dsm_i2c;
extern struct dsm_client *tp_dclient;
/* DTS2014061500170 yanghaizhou 20140615 end > */
...
/* BEGIN PN: DTS2014101601174,Modified  by yuanbo, 2014/10/16*/
struct i2c_client *captest_i2c_client = NULL;
/* END   PN: DTS2014101601174,Modified  by yuanbo, 2014/10/16*/
...
/* BEGIN PN: DTS2014101601174,Deleted by yuanbo, 2014/10/16*/
//SWID_ENUM sw_id=SWID_NULL;
/* END   PN: DTS2014101601174,Deleted by yuanbo, 2014/10/16*/
...
/* < DTS2014070908624 yanghaizhou 20140710 begin */
/*
...
/* DTS2014070908624 yanghaizhou 20140710 end > */
...
int HalTscrCDevWriteI2CSeq(u8 addr, u8* data, u16 size)
{
    ...
    rc = i2c_transfer(msg21xx_i2c_client->adapter, msgs, 1);
    /* < DTS2014060903452 yanghaizhou 20140610 begin */
    if (rc <= 0)
    /* DTS2014060903452 yanghaizhou 20140610 end > */
    {
                                      ...
                                      struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    /* < DTS2014061702958 yanghaizhou 20140617 begin */
    /* < DTS2014062407475 yanghaizhou 20140625 begin */
    /*--coverity--spintf-->snprintf--*/
     snprintf(fw_version, FW_VERSION_SIZE, "%u.%u", major, minor);   
    /* DTS2014062407475 yanghaizhou 20140625 end > */
    /* DTS2014061702958 yanghaizhou 20140617 end > */
...
/* BEGIN PN: DTS2014022703532  ,Modified by y84018358, 2014/02/27*/ 
...
/* END PN: DTS2014022703532  ,Modified by y84018358, 2014/02/27*/ 
#if CTP_PROXIMITY_FUN
...
/* DTS2014051506063 yanghaizhou 20140516 begin >*/
#ifdef REPORT_KEY_WITH_COORD
...
#endif
/* DTS2014051506063 yanghaizhou 20140516 end >*/
...
/* END   PN: DTS2014101601174,Deleted by yuanbo, 2014/10/16*/
	...
	msg2138_get_module_name(msg21xx_data->vendor_id, module_name, APP_INFO_VALUE_LENTH);
        ...
        /* DTS2014051606353 caowei 201400519 end >*/
        /* DTS2014062407475 yanghaizhou 20140625 end > */
    /* <DTS2014120200352 s00248659 20140212 begin */
    #ifdef CONFIG_APP_INFO
    ...
    /* DTS2014120200352 s00248659 20140212 end> */
	enable_irq(msg21xx_irq);
...
static void msg21xx_timer_work(struct work_struct *work)
{
    ...
    if (msg21xx_esd_check())
    {
        /* < DTS2014061500170 yanghaizhou 20140623 begin */
        msg21xx_report_dsm_erro(msg21xx_data, tp_dclient, DSM_TP_ESD_ERROR_NO, 0);
        /* DTS2014061500170 yanghaizhou 20140623 end > */        
...
MODULE_LICENSE("GPL");
/* DTS2014042508608 caowei 20140425 end >*/
