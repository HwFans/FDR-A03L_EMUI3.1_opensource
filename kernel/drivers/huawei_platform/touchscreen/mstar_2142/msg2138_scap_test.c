...
/* < DTS2014070404934 yanghaizhou 20140710 begin */
static struct mutex scap_test_mutex;
/* DTS2014070404934 yanghaizhou 20140710 end > */
...
/* < DTS2014031810537 caowei 20140319 begin */
static int g_i2c_freq = 0;
/* DTS2014031810537 caowei 20140319 end >*/
...
#define BIT0  (1<<0)
#define BIT1  (1<<1)
/* < DTS2014081601444 caowei 201400816 begin */
#define BIT2  (1<<2)
/* DTS2014081601444 caowei 201400816 end >*/
#define BIT5  (1<<5)
#define BIT11 (1<<11)
#define BIT15 (1<<15)
/* BEGIN PN: DTS2014101601174,Modified by yuanbo, 2014/10/16*/
...
#ifdef DMA_IIC
    /* < DTS2014052100624 yanghaizhou 20140521 begin */    
    //printk("hisdar debug:DMA\n");
    /* < DTS2014052100624 yanghaizhou 20140521 end */    
    if(size>8&&NULL!=I2CDMABuf_va)
	{
	    int i = 0;
	    for(i=0;i<size;i++)
...
/* < DTS2014022005207     yangzicheng 20140221 begin */
	u8  Th_Tri = 25;    // non-border threshold    
	u8  Th_bor = 40;    // border threshold    
/* DTS2014022005207     yangzicheng 20140221 end >*/
...
static int msg_scap_test_show(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    /* < DTS2014071601734 yanghaizhou 20140715 beign */
...
static int msg_scap_test_sample_show(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    int length = 0;
    u16 i = 0;
    /* < DTSDTS2014072200990 yanghaizhou 20140723 begin*/	
    unsigned int data_len = 4096;
    /* DTSDTS2014072200990 yanghaizhou 20140723 end > */	
