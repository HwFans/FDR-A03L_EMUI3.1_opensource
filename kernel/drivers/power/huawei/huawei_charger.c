...
/* < DTS2015061809777 mapengfei 20150619 begin */
#include <linux/power/bq24152_charger.h>
/* DTS2015061809777 mapengfei 20150619 end > */
...
/* < DTS2015042808111 mengxianglong 20150520 begin */
#ifdef CONFIG_LOG_JANK
#include <linux/log_jank.h>
#endif
/* DTS2015042808111 mengxianglong 20150520 end > */
/* < DTS2015060507141 chenyuanquan 20150605 begin */
#ifdef CONFIG_HUAWEI_DSM
#include <linux/dsm_pub.h>
#endif
/* DTS2015060507141 chenyuanquan 20150605 end > */
...
#endif
/* <DTS2015073101625 liyu 20150731 begin */
...
/* < DTS2015040302156 yuanzhen 20150408 begin */
...
/* DTS2015040302156 yuanzhen 20150408 end > */
...
static int get_running_test_result(struct charge_device_info *di)
{
    ...
    /* < DTS2015013107546 jiangfei 20150203 begin */
    ...
    /* DTS2015013107546 jiangfei 20150203 end > */
...
static int huawei_charger_load_battery_data(struct charge_device_info *di)
{
    ...
    if (node)
    {
        ...
        if (batt_data.warm_bat_decidegc || batt_data.cool_bat_decidegc)
        {
			...
			di->cool_bat_limit_chg_ma = (int)(3 * batt_data.fcc / 10);
        ...
        if(TI_BQ24296_CHARGER == g_charger_core_para->charger_type_info.charger_index)
        {
			...
			bq24296_temp_info.imaxma_limit_cool_bat = di->cool_bat_limit_chg_ma;
...
static irqreturn_t huawei_charger_usbin_valid_irq_handler(int irq, void *data)
{
    ...
    /* < DTS2015042808111 mengxianglong 20150520 begin Delete two rows */
...
static int charge_probe(struct spmi_device *pdev)
{
    ...
    /* < DTS2015040904261 yuanzhen 20150409 begin */
    /* move to the end of probe */
    /* DTS2015040904261 yuanzhen 20150409 end > */
    /* < DTS2015061809777 mapengfei 20150619 begin */
    if((MAX77819_CHARGER != g_charger_core_para->charger_type_info.charger_index)&&
...
/* DTS2015082203230 yinfenghang 20150822 end> */
    ...
    /* < DTS2015061809777 mapengfei 20150619 begin */
    /* < DTS2015040703740 tanyanying 20150331 begin */
    /*delte unused code */
    /* DTS2015040703740 tanyanying 20150331 end > */
    /*DTS2015061809777 mapengfei 20150619 end > */
    ...
    if(power_class)
    {
        ...
        /* < DTS2015050407765 chenyuanquan 20150504 begin */
        ...
        /* DTS2015050407765 chenyuanquan 20150504 end > */
    }
...
/* DTS2015073101625 liyu 20150731 end > */
/**********************************************************
