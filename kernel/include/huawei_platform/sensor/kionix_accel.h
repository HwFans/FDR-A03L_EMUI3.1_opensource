...
/* < DTS2015060801245 hujianglei 20150609 begin */
#define MAX_REPORT_TIMES                  3000
/* DTS2015060801245 hujianglei 20150609 end > */
...
struct kx_gs_dsm_operation{
	...
	/* < DTS2015022601898  wushengyu 20150228 begin */
	void (*judge_same_value_excep)(s16 x,s16 y,s16 z,struct kionix_accel_driver *acceld);
	/* DTS2015022601898  wushengyu 20150228 end > */
};
...
struct kionix_accel_driver {
	...
	bool negate_y;
	bool negate_z;
	/* < DTS2015052805290 hujianglei 20150602 begin */
	bool print_xyz_flag;
	/* DTS2015052805290 hujianglei 20150602 end > */
	u8 shift;
