...
struct ap3426_data {
    ...
    struct workqueue_struct	*alsps_wq;
    struct delayed_work light_report_work;
    struct work_struct prox_report_work;
    /* < DTS2016011101150 chendong 20150118 begin */
    struct delayed_work powerkey_work;
    /* DTS2016011101150 chendong 20150118 end > */

    struct work_struct  prox_enable_work;
    struct work_struct  prox_disable_work;
